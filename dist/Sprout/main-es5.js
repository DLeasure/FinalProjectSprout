...
var AboutUsComponent = /** @class */ (function () {
    ...
    AboutUsComponent.prototype.ngOnInit = function () {
        ...
        var flowers = new _animations_interactive_flowers__WEBPACK_IMPORTED_MODULE_2__["InteractiveFlowers"](canvas);
        var btn = document.getElementById('clearBtn');
        btn.addEventListener('click', function () {
            flowers.clearCanvas();
        });
    };
    AboutUsComponent.prototype.toggleJon = function () {
        this.jonInfoShown = !this.jonInfoShown;
    };
    ;
    AboutUsComponent.prototype.toggleDave = function () {
        this.daveInfoShown = !this.daveInfoShown;
    };
    ;
    AboutUsComponent.prototype.toggleJess = function () {
        this.jessInfoShown = !this.jessInfoShown;
    };
    ;
    AboutUsComponent.prototype.viewAll = function () {
        this.jonInfoShown = !this.jonInfoShown;
        this.daveInfoShown = !this.daveInfoShown;
        this.jessInfoShown = !this.jessInfoShown;
...
"";
var InteractiveFlowers = /** @class */ (function () {
    ...
    InteractiveFlowers.ctorParameters = function () { return [
...
var AppComponent = /** @class */ (function () {
    function AppComponent(earthService) {
        this.earthService = earthService;
        this.title = 'Sprout';
    }
    ;
    AppComponent.prototype.requestLatLon = function () {
        this.earthService.getUsersLatLon('US', '48044').subscribe(function (resp) {
            console.log(resp);
        });
    };
    ;
...
var EarthService = /** @class */ (function () {
    function EarthService(http) {
        this.http = http;
    }
    EarthService.prototype.getUsersLatLon = function (country, ZIP) {
        return this.http.get("http://localhost:3500/latLon/" + country + "/" + ZIP);
        // })
    };
    ;
    EarthService.prototype.getLocationFromLatLon = function (latitude, longitude) {
        return this.http.get("http://localhost:3500/location/" + latitude + "/" + longitude);
    };
    ;
    EarthService.prototype.getLocationDetails = function (locationId) {
        // return this.http.get("http://localhost:3500/locationInfo/" + locationId);
        // console.log(locationId);
        var locationObject = this.http.get("http://localhost:3500/locationInfo/" + locationId);
    ...
    EarthService.prototype.getReduceArticles = function () {
        return this.http.get("http://localhost:3500/reduce/");
    };
    ;
    //function to get Reduce article details from Proxy Server
    EarthService.prototype.getArticleDetails = function (reduceURL) {
        var decodeURL = decodeURI(reduceURL);
        return this.http.get("http://localhost:3500/reduce/details/" + decodeURL);
    };
    EarthService.ctorParameters = function () { return [
...
var FlowerRandomizationService = /** @class */ (function () {
    ...
    FlowerRandomizationService.prototype.getFlowerAt = function (point) {
        var flowerCenter = new _models_flower_center__WEBPACK_IMPORTED_MODULE_2__["FlowerCenter"](point, this.randomIntFromInterval(5, 16), this.randomColor());
        ...
        var petal = new _models_petal__WEBPACK_IMPORTED_MODULE_3__["Petal"](point, this.randomIntFromInterval(20, 50), this.randomIntFromInterval(9, 14) / 10, petalAngleSpan, this.randomColor());
...
var LandingComponent = /** @class */ (function () {
    ...
    LandingComponent.prototype.updateSelectedComponent = function (component) {
...
var MapsService = /** @class */ (function () {
    ...
    MapsService.prototype.openLocationInMaps = function (lat, lng) {
...
var FlowerCenter = /** @class */ (function () {
    ...
    FlowerCenter.ctorParameters = function () { return [
...
var Flower = /** @class */ (function () {
    ...
    Flower.ctorParameters = function () { return [
...
var Petal = /** @class */ (function () {
    ...
    Petal.ctorParameters = function () { return [
        { type: _point__WEBPACK_IMPORTED_MODULE_0__["Point"] },
        { type: Number },
        { type: Number },
        { type: Number },
...
var QuizComponent = /** @class */ (function () {
    function QuizComponent(_quizInfoService) {
        this._quizInfoService = _quizInfoService;
    }
    QuizComponent.prototype.ngOnInit = function () {
        this.initalize();
    };
    QuizComponent.prototype.initalize = function () {
        this._displayTitle = true;
        this._quizInfoService.getJson().subscribe(this.onSuccess.bind(this), this.onError.bind(this));
    };
    QuizComponent.prototype.generateOrderForAnswers = function () {
        var answers = this._questionAndAnswer.others;
        ...
        var _loop_1 = function (i) {
            ...
            answers = answers.filter(function (a) { return a !== answers[index]; });
        };
    ...
    QuizComponent.prototype.onSuccess = function (items) {
        var final = items.map(function (res) {
    ...
    QuizComponent.prototype.onError = function (error) {
        console.log(error);
    };
    QuizComponent.prototype.getQuestion = function () {
        var nonUsed = this._questionsAndAnswers.filter(function (qanda) { return !qanda.answered; });
        var randomIndex = Math.floor(Math.random() * Math.floor(nonUsed.length));
        var question = nonUsed[randomIndex];
        return question;
    };
    QuizComponent.prototype.getCorrectAmount = function () {
        var correctQuestions = this._questionsAndAnswers.filter(function (item) { return item.correct; });
    ...
    QuizComponent.prototype.submitAnswer = function (answer) {
        var index = this._questionsAndAnswers.indexOf(this._questionAndAnswer);
...
var RecycleComponent = /** @class */ (function () {
    function RecycleComponent(earthService, mapsService) {
        this.earthService = earthService;
    ...
    ;
    RecycleComponent.prototype.openInMaps = function (lat, lng) {
        return this.mapsService.openLocationInMaps(lat, lng);
    };
    ;
    RecycleComponent.prototype.requestLatLonAndLocation = function () {
        var _this = this;
        if (this.ZIP > 4999 && this.ZIP < 100000) {
            // console.log("searching for " + this.ZIP);
            this.earthService.getUsersLatLon(this.country, this.ZIP).subscribe(function (resp) {
                if (resp !== null) {
                    // console.log(resp);
                    _this.latitude = resp.latitude;
                    _this.longitude = resp.longitude;
                    // console.log(resp);
                    _this.requestLocation();
                }
                else {
                    _this.errorMessage = "Zip code not found";
                }
                ;
            });
        }
    ...
    ;
    RecycleComponent.prototype.requestLocation = function () {
        var _this = this;
        this.earthService.getLocationFromLatLon(this.latitude, this.longitude).subscribe(function (resp) {
            // console.log("second API request ran");
            // console.log(resp);
            for (var index = 0; index < 20; index++) {
                _this.responseArrayKeys[index] = (resp[index].location_id);
            }
            ;
            // console.log(this.responseArrayKeys);
            _this.requestLocationDetails();
        });
    };
    ;
    RecycleComponent.prototype.requestLocationDetails = function () {
        var _this = this;
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["forkJoin"])(promises).subscribe(function (values) {
            console.log("ran");
            // console.log(values);
            if (values === null) {
                _this.errorMessage = "no results found";
            }
            _this.responseArrayObjects = values;
            _this.errorMessage = "";
            console.log(_this.responseArrayObjects);
        });
    };
    ;
    RecycleComponent.prototype.ngOnInit = function () {
        var integerForRecyclingFact = Math.floor(Math.random() * this.recyclingFacts.length);
        this.recyclingFact = this.recyclingFacts[integerForRecyclingFact];
    };
    RecycleComponent.ctorParameters = function () { return [
        { type: _earth_service__WEBPACK_IMPORTED_MODULE_2__["EarthService"] },
...
var ReduceComponent = /** @class */ (function () {
    function ReduceComponent(earthService, router) {
        var _this = this;
        this.earthService = earthService;
        this.router = router;
        this.reduceURL = "";
        this.articleShown = false;
        this.earthService.getReduceArticles().subscribe(function (res) {
            _this.allArticles = res.result;
        });
    }
    ReduceComponent.prototype.requestArticleDetails = function (e) {
        var _this = this;
        this.reduceURL = encodeURIComponent(e.target.value);
        var decodeURL = decodeURIComponent(this.reduceURL);
        this.earthService.getArticleDetails(this.reduceURL).subscribe(function (res) {
            _this.articleDets = res["" + decodeURL];
            _this.articleContent = _this.articleDets.content;
            var regex = /(\[caption[^>]*].*?\[\/caption])/gm;
            _this.cleanArticleContent = _this.articleContent.replace(regex, "");
            _this.articleShown = true;
            _this.reduceDes = _this.articleDets.description;
        });
    };
    ;
    ReduceComponent.prototype.scrollToTop = function () {
        window.scroll(0, 0);
    };
    ReduceComponent.prototype.ngOnInit = function () {
    };
    ReduceComponent.ctorParameters = function () { return [
        { type: _earth_service__WEBPACK_IMPORTED_MODULE_2__["EarthService"] },
...
var ReuseService = /** @class */ (function () {
    function ReuseService(_http) {
        this._http = _http;
    }
    ReuseService.prototype.getData = function () {
        return this._http.get('https://www.reddit.com/r/Reuse/.json');
    };
    ReuseService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var ReuseComponent = /** @class */ (function () {
    function ReuseComponent(reuseService) {
        this.reuseService = reuseService;
    }
    ReuseComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.reuseItems = [];
        this.reuseService.getData().subscribe(function (res) {
            res.data.children.forEach(function (item) {
                ...
                _this.reuseItems.push(reuseObject);
            });
        });
    };
    ReuseComponent.ctorParameters = function () { return [
...
var QuizInfoService = /** @class */ (function () {
    function QuizInfoService(_http) {
        this._http = _http;
    }
    QuizInfoService.prototype.getJson = function () {
        return this._http.get('../../assets/q-and-a-data.json');
    };
    QuizInfoService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var SproutHomeComponent = /** @class */ (function () {
    function SproutHomeComponent() {
    }
    SproutHomeComponent.prototype.ngOnInit = function () {
    };
    SproutHomeComponent.prototype.optionClicked = function () {
